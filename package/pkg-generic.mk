...
$$($(2)_TARGET_INSTALL_TARGET):		NAME=$(1)
...
ifeq ($$($$($(2)_KCONFIG_VAR)),m)
$$($(2)_DIR)/.stamp_target_installed: TARGET_DIR := $(MODULES_DIR)/$(1)
$$($(2)_DIR)/.stamp_target_installed: $(MODULES_DIR)/$(1)
$$(MODULES_DIR)/$(1):
	mkdir -p $$@
endif
